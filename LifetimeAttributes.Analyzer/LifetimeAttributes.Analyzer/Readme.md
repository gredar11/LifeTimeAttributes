...
### LifetimeAttributes.Analyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [LifetimeAttributes.Analyzer.Sample.csproj](../LifetimeAttributes.Analyzer.Sample/LifetimeAttributes.Analyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### LifetimeAttributes.Analyzer.Tests
